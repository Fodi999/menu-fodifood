...
### 🔧 Для администраторов
- **🛒 Единая корзина компонентов v2.0** — новая система управления продуктами:
  - 🥬 Добавление ингредиентов с фильтрацией по категориям
  - 📦 Добавление полуфабрикатов из готового списка
  - 🧮 Автоматический расчёт себестоимости, веса, наценки
  - 🎨 Визуальная индикация типов компонентов (зелёный/фиолетовый)
  - 🔥 Поддержка термообработки с ручным вводом веса
  - ✅ Валидация и автоформатирование до 3 знаков
- 👥 **Управление пользователями** - просмотр, редактирование, блокировка
- 📦 **Управление заказами** - обработка, статусы, история
