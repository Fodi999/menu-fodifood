...
-- CreateIndex
CREATE UNIQUE INDEX "TechCard_productId_key" ON "TechCard"("productId");
...
-- AddForeignKey
ALTER TABLE "TechCard" ADD CONSTRAINT "TechCard_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
